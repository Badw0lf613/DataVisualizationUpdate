...
setInterval(get_c1_data,1000*10) // 10秒刷一次
setInterval(get_c2_data,10000*10) // 100秒刷一次
setInterval(get_l1_data,10000*10) // 100秒刷一次
setInterval(get_l2_data,10000*10) // 100秒刷一次
setInterval(get_r1_data,10000*10) // 100秒刷一次
setInterval(get_r2_data,10000*10) // 100秒刷一次
